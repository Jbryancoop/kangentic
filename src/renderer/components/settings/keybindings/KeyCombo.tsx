 ...
 * the spoken form so screen readers announce the shortcut once cleanly. The chip
 * styling is identical for rebindable and fixed shortcuts; a lock icon (rendered
