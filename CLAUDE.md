...
- **Active-implementation skills** verify by auto-spawning their auditor agent (delegation), not by forking. Example targets: `add-ipc-endpoint` to `ipc-auditor`, `add-migration` to `migration-safety`.
